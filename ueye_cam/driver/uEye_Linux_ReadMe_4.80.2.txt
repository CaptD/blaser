Download link: https://www.dropbox.com/sh/2ffzf39z9znr9ch/AABD-AD5cMyIfckmdMy351yPa?dl=0
#####################################################################################
...
IMPORTANT NOTES
 - From IDS Software Suite 4.80.1 on,  libc version 2.13 and libstdc++ version 6.0.17 have to be installed.
 - Installation of uEye Linux 4.80 will break USB driver installations prior to 4.80.
...
/usr/lib/libueye_api.so.4.80         32bit uEye shared library *
/usr/lib/libueye_api64.so.4.80       64bit uEye shared library *
...
The current API version shipped with this setup package is 4.80.0000.
...
Below is a list of tested and succeeded platforms and distributions for the CURRENT SDK release:
    ...
    Debian 8.4              i386 / i686                 ueyesdk-setup-<version>-i686.gz.run
    Debian 8.4              amd64 / amd64               ueyesdk-setup-<version>-amd64.gz.run
