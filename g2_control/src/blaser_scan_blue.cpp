...
BlaserScan::BlaserScan() {
	pcl_sub = nh.subscribe("/camera_1/PointCloud", 10, &BlaserScan::updatePointCloud, this);
	pcl_save_sub = nh.subscribe("/save", 10, &BlaserScan::output_pcd, this);
	pcl_pub = nh.advertise<sensor_msgs::PointCloud2>("/camera_1/allScan",10);
...
int main(int argc, char** argv){
  ros::init(argc, argv, "blaser_scan_blue");
